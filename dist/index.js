...
/******/ 		return __webpack_require__(806);
/******/ 	};
/******/
/******/ 	// run startup
/******/ 	return startup();
...
const core = __webpack_require__(887);
...
async function buildPushAndDeploy() {
  ...
  try {
    await exec(`(cd ${dockerFilePath}; docker build . --file Dockerfile --tag registry.heroku.com/${appName}/web)`);
...
const command_1 = __webpack_require__(916);
