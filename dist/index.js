...
const command_1 = __nccwpck_require__(693);
const file_command_1 = __nccwpck_require__(719);
const utils_1 = __nccwpck_require__(953);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(282);
/**
...
const http_client_1 = __nccwpck_require__(752);
const auth_1 = __nccwpck_require__(813);
const core_1 = __nccwpck_require__(934);
class OidcClient {
...
const pm = __nccwpck_require__(859);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(615);
            }
            const agentOptions = {
...
module.exports = __nccwpck_require__(899);
...
const scripts_1 = __nccwpck_require__(557);
const login_1 = __importDefault(__nccwpck_require__(188));
const herokuAction = (0, scripts_1.herokuActionSetup)((0, core_1.getInput)('app_name'));
(0, login_1.default)()
    .then(() => __awaiter(void 0, void 0, void 0, function* () {
    (0, child_process_1.exec)(herokuAction('push'), { maxBuffer: 1024 * 1024 }, (error, stdout, stderr) => {
        if (error)
    ...
    .then(() => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, child_process_1.exec)(herokuAction('release'), { maxBuffer: 1024 * 1024 }, (error, stdout, stderr) => {
        if (error)
            throw new Error(`stderr: ${stderr}`);
        (0, core_1.info)(`stdout: ${stdout}`);
    });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(934));
const child_process_1 = __nccwpck_require__(81);
