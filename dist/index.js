...
const utils_1 = __nccwpck_require__(863);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(715);
const file_command_1 = __nccwpck_require__(122);
const utils_1 = __nccwpck_require__(863);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(411);
/**
...
const auth_1 = __nccwpck_require__(282);
const core_1 = __nccwpck_require__(160);
class OidcClient {
...
const pm = __nccwpck_require__(517);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(820);
            }
            const agentOptions = {
...
module.exports = __nccwpck_require__(874);
...
const scripts_1 = __nccwpck_require__(745);
const login_1 = __importDefault(__nccwpck_require__(637));
...
(0, login_1.default)()
    ...
    .then(() => __awaiter(void 0, void 0, void 0, function* () {
    (0, child_process_1.exec)(herokuAction('release'), { maxBuffer: 1024 * 1024 }, (error, stdout, stderr) => {
        if (error)
            throw new Error(`stderr: ${stderr}`);
        (0, core_1.info)(`stdout: ${stdout}`);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(160));
const child_process_1 = __nccwpck_require__(81);
