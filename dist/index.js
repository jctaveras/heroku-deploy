...
const file_command_1 = __nccwpck_require__(794);
const utils_1 = __nccwpck_require__(709);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(660);
/**
...
const http_client_1 = __nccwpck_require__(97);
const auth_1 = __nccwpck_require__(312);
const core_1 = __nccwpck_require__(874);
class OidcClient {
...
const pm = __nccwpck_require__(679);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(859);
            }
            const agentOptions = {
...
const scripts_1 = __nccwpck_require__(705);
const login_1 = __importDefault(__nccwpck_require__(308));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(874));
const child_process_1 = __nccwpck_require__(81);
const util_1 = __nccwpck_require__(837);
const scripts_1 = __nccwpck_require__(705);
