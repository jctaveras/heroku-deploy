...
const utils_1 = __nccwpck_require__(824);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(332);
const file_command_1 = __nccwpck_require__(474);
const utils_1 = __nccwpck_require__(824);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(291);
/**
...
const http_client_1 = __nccwpck_require__(428);
const auth_1 = __nccwpck_require__(591);
const core_1 = __nccwpck_require__(241);
class OidcClient {
...
const scripts_1 = __nccwpck_require__(3);
const login_1 = __importDefault(__nccwpck_require__(201));
const herokuAction = (0, scripts_1.herokuActionSetup)((0, core_1.getInput)('app_name'));
(0, login_1.default)()
    .then(() => __awaiter(void 0, void 0, void 0, function* () {
    const child = (0, child_process_1.spawn)(herokuAction('push'));
    child.stdout.on('data', (chunk) => (0, core_1.info)(chunk.toString()));
    (0, core_1.info)('Your Docker image was built and pushed to Heroku Container Registry.');
}))
    .then(() => __awaiter(void 0, void 0, void 0, function* () {
    const child = (0, child_process_1.spawn)(herokuAction('release'));
    child.stdout.on('data', (chunk) => (0, core_1.info)(chunk.toString()));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(241));
const child_process_1 = __nccwpck_require__(81);
