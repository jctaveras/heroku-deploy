...
const utils_1 = __nccwpck_require__(493);
/**
 * Commands
 *
 * Command Format:
...
const command_1 = __nccwpck_require__(664);
const file_command_1 = __nccwpck_require__(286);
const utils_1 = __nccwpck_require__(493);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(528);
/**
...
const http_client_1 = __nccwpck_require__(281);
const auth_1 = __nccwpck_require__(453);
const core_1 = __nccwpck_require__(390);
class OidcClient {
...
const pm = __nccwpck_require__(923);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(844);
            }
            const agentOptions = {
...
module.exports = __nccwpck_require__(344);
...
const scripts_1 = __nccwpck_require__(760);
const login_1 = __importDefault(__nccwpck_require__(722));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(390));
const child_process_1 = __nccwpck_require__(81);
const util_1 = __nccwpck_require__(837);
const scripts_1 = __nccwpck_require__(760);
